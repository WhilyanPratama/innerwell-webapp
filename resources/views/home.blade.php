{{-- resources/views/innerwell_klinic.blade.php --}}
<!DOCTYPE html>
<html lang="id" class="scroll-smooth">
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>InnerWell Klinic - Layanan Kesehatan Modern</title>
    ...
    <header class="sticky top-0 z-50 w-full bg-white shadow-sm border-b border-gray-200">
        <div class="container mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
            ...
            <div class="flex items-center space-x-2">
                @auth
                    {{-- Tampilkan info user dan tombol logout jika sudah login --}}
            ...
            <div class="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-10 lg:gap-20 items-center">
                    ...
                    <div class="md:pr-8">
                        ...
                        {{-- Call to Action Button (Approximating Shadcn primary large button) --}}
                        @auth
                    ...
                    <div class="space-y-3 text-sm">
                        ...
                        <div class="flex items-start space-x-3">
                            ...
                            <a href="mailto:InnerWell@email.com" class="hover:text-white transition-colors">
                                InnerWell@email.com {{-- Placeholder email --}}
                            </a>
                        </div>
                        {{-- Address --}}
                        <div class="flex items-start space-x-3">
                            ...
                            <span>Surakarta</span> {{-- Location --}}
                        </div>
                    </div>
                </div>
            </div>
            {{-- Copyright or additional footer info can go here --}}
            <div class="border-t border-gray-700 pt-8 mt-8 text-center text-sm">
                &copy; {{ date('Y') }} InnerWell Klinic. All rights reserved.
            </div>
        </div>
    </footer>
